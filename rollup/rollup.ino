...
#define RIGHT_WHEEL_ENA 5
#define RIGHT_WHEEL_IN1 8
#define RIGHT_WHEEL_IN2 7

#define LEFT_WHEEL_ENA 3
#define LEFT_WHEEL_IN1 4
#define LEFT_WHEEL_IN2 2

#define SHOVEL_ROTATION_PIN A2
#define LIFT_RELAY_PIN A3
